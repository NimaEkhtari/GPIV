...
cell_size = 1
margin = 10          # margin around the dataset to avoid empty TIN triangles (in pixels)
epsg = 6344 #32615
...
for C in c:
    print('Sx = {} and Sy = {}'.format(np.round(np.sqrt(C[1][0][0]), 4), np.round(np.sqrt(C[1][1][1]), 4)))